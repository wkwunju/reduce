...
"""
        ...
        html_content = f"""<html>
<head></head>
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; color: #1a1a1a; line-height: 1.6;">
    <h2 style="letter-spacing: 0.08em;">XTRACT FLASH</h2>
    <h3>Summary</h3>
