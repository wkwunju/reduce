...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #1a1a1a; margin: 0; padding: 20px; background-color: #f5f5f5;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 30px;">
            <!-- Meta Information -->
            <div style="background-color: #f9f9f9; border-left: 4px solid #1a1a1a; padding: 15px; margin-bottom: 20px; border-radius: 4px;">
            ...
            <div style="background-color: #f9f9f9; padding: 20px; border-left: 4px solid #666666; border-radius: 4px; white-space: pre-wrap; line-height: 1.8; font-size: 14px;">
{summary}
            </div>
        </div>
